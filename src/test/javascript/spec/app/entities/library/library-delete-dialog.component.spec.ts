...
import { LibraryDeleteDialogComponent } from 'app/entities/library/library-delete-dialog.component';
import { LibraryService } from 'app/entities/library/library.service';

describe('Component Tests', () => {
  describe('Library Management Delete Component', () => {
    let comp: LibraryDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LibraryDeleteDialogComponent, '')
        .compileComponents();
