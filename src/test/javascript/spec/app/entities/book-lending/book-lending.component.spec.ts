...
import { BookLendingComponent } from 'app/entities/book-lending/book-lending.component';
...
describe('Component Tests', () => {
  describe('BookLending Management Component', () => {
    let comp: BookLendingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BookLendingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookLendings && comp.bookLendings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
