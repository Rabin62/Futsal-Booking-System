...
import { LibrarianComponent } from 'app/entities/librarian/librarian.component';
  ...
  describe('Librarian Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LibrarianComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.librarians && comp.librarians[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
