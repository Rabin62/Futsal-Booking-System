...
export class LibraryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.libraryService
      ...
      .subscribe(
        (res: HttpResponse<ILibrary[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLibraries(): void {
    this.eventSubscriber = this.eventManager.subscribe('libraryListModification', () => this.loadPage());
  }
