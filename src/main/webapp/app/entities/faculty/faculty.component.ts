...
export class FacultyComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.facultyService
      ...
      .subscribe(
        (res: HttpResponse<IFaculty[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFaculties(): void {
    this.eventSubscriber = this.eventManager.subscribe('facultyListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFaculty[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
