...
export class SemesterComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.semesterService
      ...
      .subscribe(
        (res: HttpResponse<ISemester[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSemesters(): void {
    this.eventSubscriber = this.eventManager.subscribe('semesterListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISemester[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
